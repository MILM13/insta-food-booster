...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Diagnóstico estratégico de 1eos Fast Food: FODA, Porter, objetivos y población." },
      { property: "og:title", content: "1eos Fast Food — Brief Estratégico" },
      { property: "og:description", content: "Brief de marketing y comercialización para 1eos Fast Food." },
